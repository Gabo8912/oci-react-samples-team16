...
public class ToDoItemBotController extends TelegramLongPollingBot {
    ...
    private void handleDoneCommand(long chatId, String messageText) {
    ...
    private void handleUndoCommand(long chatId, String messageText) {
    ...
    private void handleNewItem(long chatId, String messageText) {
        try {
